var aboutAdvertiserModule = angular.module('aboutAdvertiserModule',['ngRoute','serverCommunicationModule']);

aboutAdvertiserModule.controller('aboutAdvCntrl', function ($scope, serverApi) {
